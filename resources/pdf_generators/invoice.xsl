...
<xsl:import href="pdf.d/essentials.xsl"/>
<xsl:import href="pdf.d/company.xsl"/>

<!-- union stuff -->
<xsl:import href="pdf.d/our_union/essentials.xsl"/>
<xsl:import href="pdf.d/our_union/full_no_logo.xsl"/>

<!-- translations -->
<xsl:import href="pdf.d/i18n/invoices/default.xsl"/>
        ...
        <fo:page-sequence master-reference="document">
            <fo:static-content flow-name="footer-block">
                <fo:block font-size="8pt" font-family="sans-serif" padding-before="0.5mm"
                        border-before-color="black" border-before-style="solid" border-before-width="0.15mm" color="grey" text-align="center">
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                ...
                                <fo:table-cell margin-left="0px">
                                    <fo:block text-align="right" padding-after="30px" 
                                                margin-top="30px" 
                                                font-size="16pt" 
                                                font-weight="bold" 
                                                color="#DDDDDD">
...
<xsl:template match="empty_line">
    <fo:table-row>
        <fo:table-cell display-align="center" text-align="left" 
                       margin-right="0px" margin-left="5px" padding-before="2px" 
                       border-right-style="solid" border-right-width="1px"
                       border-left-style="solid" border-left-width="1px">
            <fo:block><xsl:text>&#x00A0;</xsl:text></fo:block>
        </fo:table-cell>
        <fo:table-cell display-align="center" text-align="right" 
                       margin-right="5px" margin-left="0px" padding-before="2px" 
                       border-right-style="solid" border-right-width="1px"
                       border-left-style="solid" border-left-width="1px">
            <fo:block><xsl:text>&#x00A0;</xsl:text></fo:block>
        </fo:table-cell>
        <fo:table-cell display-align="center" text-align="center" 
                       margin-right="0px" margin-left="0px" padding-before="2px" 
                       border-right-style="solid" border-right-width="1px"
                       border-left-style="solid" border-left-width="1px">
            <fo:block><xsl:text>&#x00A0;</xsl:text></fo:block>
        </fo:table-cell>
