 ...
 */
class LitusEntityCudiArticlesMetaInfoProxy extends \Litus\Entity\Cudi\Articles\MetaInfo implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'article', 'authors', 'publishers', 'yearPublished');
    }
