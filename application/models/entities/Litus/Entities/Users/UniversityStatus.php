...
/**
 * @Entity(repositoryClass="Litus\Repositories\Users\UniversityStatusRepository")
...
class UniversityStatus
{
     ...
     *
     * @Column(name="person")
     * @ManyToOne(targetEntity="Litus\Entities\Users\Person", cascade={"all"}, fetch="LAZY", inversedBy="universityStatuses")
     */
    private $person;
