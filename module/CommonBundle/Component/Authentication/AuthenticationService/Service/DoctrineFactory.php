...
namespace CommonBundle\Component\Authentication\AuthenticationService\Service;
...
class DoctrineFactory implements FactoryInterface
{
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new DoctrineAuthenticationService(
            $container->get('doctrine.entitymanager.orm_default'),
            Session::class,
    ...
    {
        return $this($serviceLocator, 'CommonBundle\Component\Authentication\AuthenticationService\Doctrine');
    }
}
