...
class Event extends \CommonBundle\Component\Hydrator\Hydrator
{
    ...
    protected function doExtract($object = null)
    {
        ...
        if (sizeof($object->getOptions()) == 0) {
            $data['prices']['price_members'] = number_format($object->getPriceMembers(), 2);
            $data['prices']['price_non_members'] = $object->isOnlyMembers() ? '' : number_format($object->getPriceNonMembers(), 2);
        } else {
