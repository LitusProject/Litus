...
/**
 * @ORM\Entity(repositoryClass="TicketBundle\Repository\Order")
...
class Order
{
    ...
    /**
     * @var Ticket The tickets of this order
     *
     * @ORM\OneToMany(targetEntity="TicketBundle\Entity\Ticket", mappedBy="order")
     */
    private $tickets;
