...
return array(
    'router' => array(
        'routes' => array(
            ...
            'cudi_admin_sales_article_template' => array(
                'type' => 'Zend\Mvc\Router\Http\Segment',
                'options' => array(
                    'route' => '/admin/sales/article/template[/:action[/:id]][/]',
                    'constraints' => array(
                        'action'  => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id'      => '[0-9]*',
                    ),
                    'defaults' => array(
                        'controller' => 'cudi_admin_sales_article_template',
                        'action'     => 'manage',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'cudi_admin_sales_article_template'    => 'CudiBundle\Controller\Admin\Sale\Article\TemplateController',
