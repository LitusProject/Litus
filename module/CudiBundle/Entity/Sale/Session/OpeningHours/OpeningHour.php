...
namespace CudiBundle\Entity\Sale\Session\OpeningHours;
...
class OpeningHour
{
     ...
     *
     * @ORM\OneToMany(targetEntity="CudiBundle\Entity\Sale\Session\OpeningHours\Translation", mappedBy="openingHour", cascade={"remove"})
     */
    ...
    /**
     * @param \DateTime $startDate
     * @return \CudiBundle\Entity\Sale\Session\OpeningHours\OpeningHours
     */
    ...
    /**
     * @param \DateTime $endDate
     * @return \CudiBundle\Entity\Sale\Session\OpeningHours\OpeningHour
     */
     ...
     * @return \CudiBundle\Entity\Sale\Session\OpeningHours\Translation
     */
