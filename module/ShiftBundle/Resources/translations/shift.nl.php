...
return array(
    ...
    'You need to do <span class="label label-info"> %shiftsToNextRanking% </span> more shift(s) to get the next ranking.' => 'Je moet nog <span class="label label-info"> %shiftsToNextRanking% </span> shift(en) meer doen om de volgende ranking te bereiken.',
    'Your current shiftranking is <span class="label label-info"> %ranking% </span>.' => 'Je huidige shiftranking is <span class="label label-info"> %ranking% </span>.',
);
