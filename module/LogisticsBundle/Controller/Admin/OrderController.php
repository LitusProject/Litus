...
//use LogisticsBundle\Entity\Order\AbstractOrderArticleMap;
...
//            ->getRepository('LogisticsBundle\Entity\Order\AbstractOrderArticleMap')
...
//                            $booking = new AbstractOrderArticleMap($newOrder, $article, $amount, $oldAmount, $comment);
//                            if ($oldAmount == $amount) {
...
//                        } else {
//                            $booking = new AbstractOrderArticleMap($newOrder, $article, $oldAmount, $oldAmount);
//                        }
...
//            if ($article->getUnit() === $reviewingUnit) {
//                $newMapping = new AbstractOrderArticleMap($newOrder, $mapping->getArticle(), $mapping->getAmount(), $mapping->getAmount());
...
//            $article = $mapping->getArticle();
//            if ($article->getUnit() === $reviewingUnit) {
//                $newMapping = new AbstractOrderArticleMap($newOrder, $article, $mapping->getAmount(), $mapping->getAmount());
...
//
//                        if ($map === null) {
//                            $this->getEntityManager()->persist(new Order\AbstractOrderArticleMap($order, $article, 1));
//                        } else {
...
//
//    /**
//     * @return AbstractOrderArticleMap |null
//     */
//    private function getArticleMapEntity()
//    {
//        $map = $this->getEntityById('LogisticsBundle\Entity\Order\AbstractOrderArticleMap', 'map');
//
//        if (!($map instanceof AbstractOrderArticleMap)) {
//            $this->flashMessenger()->error(
//                'Error',
...
//    }
//
//    private function findOverlapping(array $array, AbstractOrderArticleMap $mapping)
//    {
