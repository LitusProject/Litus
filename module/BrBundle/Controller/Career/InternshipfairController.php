...
/**
 * InternshipfairController
 *
 * Copied from CompanyController
 */
class InternshipfairController extends \BrBundle\Component\Controller\CareerController
{
    ...
    public function searchAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $pages = $this->getEntityManager()
                ...
                ->findAllAtEventBySearch($this->getCurrentAcademicYear(), $data['query'], $data['sector']);
