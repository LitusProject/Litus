 ...
 */
class CudiBundleEntityFileProxy extends \CudiBundle\Entity\File implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setInternalArticle(\CudiBundle\Entity\Articles\StockArticles\Internal $internalArticle)
    {
        $this->__load();
