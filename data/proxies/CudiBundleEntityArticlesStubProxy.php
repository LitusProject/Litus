 ...
 */
class CudiBundleEntityArticlesStubProxy extends \CudiBundle\Entity\Articles\Stub implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'timestamp', 'removed', 'versionNumber', 'metaInfo', 'stockItem');
    }
