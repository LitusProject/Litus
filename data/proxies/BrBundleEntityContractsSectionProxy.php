 ...
 */
class BrBundleEntityContractsSectionProxy extends \BrBundle\Entity\Contracts\Section implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'content', 'year', 'price', 'vatType', 'invoiceDescription', 'author');
    }
