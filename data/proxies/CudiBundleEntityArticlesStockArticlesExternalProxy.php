 ...
 */
class CudiBundleEntityArticlesStockArticlesExternalProxy extends \CudiBundle\Entity\Articles\StockArticles\External implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'timestamp', 'removed', 'versionNumber', 'metaInfo', 'stockItem', 'purchasePrice', 'sellPrice', 'sellPriceMembers', 'barcode', 'bookable', 'unbookable', 'canExpire', 'supplier');
    }
