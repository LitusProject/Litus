 ...
 */
class CommonBundleEntityUsersPeopleCompanyProxy extends \CommonBundle\Entity\Users\People\Company implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'username', 'firstName', 'lastName', 'email', 'address', 'telephone', 'sex', 'canLogin', 'credential', 'roles', 'name', 'vatNumber');
    }
