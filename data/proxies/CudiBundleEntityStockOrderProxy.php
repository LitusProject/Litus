 ...
 */
class CudiBundleEntityStockOrderProxy extends \CudiBundle\Entity\Stock\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date', 'supplier', 'orderItems');
    }
