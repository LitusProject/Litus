...
>
            ...
            <fo:table-body>
                <fo:table-row>
                    ...
                    <fo:table-cell padding-start="3mm">
                        ...
                        <fo:block text-align="left" font-size="12pt"><xsl:call-template name="companieslist"/></fo:block>
                    </fo:table-cell>
                    <fo:table-cell>
                ...
                <fo:table table-layout="fixed" width="100%" margin-bottom="5mm">
                    ...
                    <fo:table-header>
                        <fo:table-row>
                            ...
                            <fo:table-cell padding-start="2mm" padding-before="1mm" padding-after="1mm" border-style="solid" border-width="0.5mm" border-color="black">
                                <fo:block text-align="left" font-weight="bold"><xsl:call-template name="username"/></fo:block>
                            </fo:table-cell>
                            <fo:table-cell padding-before="1mm" padding-after="1mm" border-style="solid" border-width="0.5mm" border-color="black">
                                <fo:block text-align="center" font-weight="bold"><xsl:call-template name="email"/></fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    </fo:table-header>
    ...
    <xsl:template match="person">
        <fo:table-row>
            ...
            <fo:table-cell padding-start="2mm" padding-before="1mm" padding-after="1mm" border-style="solid" border-width="0.5mm" border-color="black">
                <fo:block text-align="left"><xsl:apply-templates select="username"/></fo:block>
            </fo:table-cell>
            <fo:table-cell padding-before="1mm" padding-after="1mm" border-style="solid" border-width="0.5mm" border-color="black">
