...
>
    ...
    <xsl:template match="sale_conditions_nl">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">9.1. Voor Sector Nights, BR Launches of gelijkaardige evenementen zal bij een overschakeling naar een online alternatief een compensatie geleverd worden in de vorm van een gratis door VTK aangewezen optie uit de door VTK opgestelde Collaboration Brochure van het academiejaar waarin het contract geldig is.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">9.2. Voor Internship Fair, Jobfair of gelijkaardige evenementen zal bij een overschakeling naar een online alternatief een financiële compensatie geleverd worden van 25% van de prijs van de desbetreffende optie waarvoor fysieke aanwezigheid vereist is.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
