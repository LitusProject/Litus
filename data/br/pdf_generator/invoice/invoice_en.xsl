...
>
    ...
    <xsl:template match="sale_conditions_nl">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">9.1. For Sector Nights, BR Launches or similar events, a conversion to an online event will induce a compensation in the form of a free option appointed by VTK from the Collaboration Brochure drawn up by VTK of the same academic year in which the contract was valid.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">9.2. For Internship Fair, Jobfair or similar events, a conversion to an online event will induce a financial compensation of 25% of the price of the concerning option that requires physical presence.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
