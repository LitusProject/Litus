...
>>>>>>> master
    ...
    <xsl:template match="sale_conditions_nl">
        ...
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm">2.2.2. Voor goederen of engagementen die bij het tekenen van de overeenkomst niet gekoppeld zijn aan een fysiek evenement zal bij annulatie een vergoeding van 35% verschuldigd zijn van de prijs.</fo:block>
        <fo:block font-size="8pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
        ...
        <fo:block font-size="8pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
            Artikel 10: Maatregelen die ons verplichten tot wijzigen van het evenement</fo:block>
        ...
        <fo:block font-size="8pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
            Artikel 12: Toepasselijk recht</fo:block>
        ...
        <fo:block font-size="8pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
            Artikel 13: Geschillen</fo:block>
