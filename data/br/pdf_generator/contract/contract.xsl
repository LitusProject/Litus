...
>>>>>>> master
    ...
    <xsl:template match="sale_conditions_nl">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">Deze algemene voorwaarden gelden voor alle contracten afgesloten door VTK Ondersteuning VZW. De medecontractant wordt geacht ze te aanvaarden door het enkel feit van de ondertekening van het contract. Afwijking van deze verkoopsvoorwaarden, zelfs indien vermeld op documenten uitgaande van de medecontractant zijn alleen dan aan VTK Ondersteuning V tegenstelbaar wanneer zij door VTK Ondersteuning VZW schriftelijk werden bevestigd. In dat geval blijven alle overige verkoopsvoorwaarden van kracht waarvan niet uitdrukkelijk werd afgeweken.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">2.2. Elke annulering van de bestelling dient schriftelijk te geschieden. Zij is slechts geldig mits schriftelijke aanvaarding door VTK Ondersteuning VZW. Ingeval van annulering is de medecontractant een forfaitaire vergoeding verschuldigd afhankelijk van het onderwerp van de overeenkomst, deze dekt de vaste en variabele kosten en mogelijke winstderving.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">2.2.1. Voor Sector Nights, BR Launches, Internship Fair, Jobfair of gelijkaardige evenementen zal bij een annulatie tot en met 40 dagen voor het evenement 35% van het overeengekomen bedrag aangerekend worden, van 39 tot en met 21 dagen voor het evenement 60% van het overeengekomen bedrag aangerekend worden en vanaf 20 dagen voor het evenement zal 100% van dit bedrag aangerekend worden.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">2.2.2. Voor goederen of engagementen die bij het tekenen van de overeenkomst niet gekoppeld zijn aan een fysiek evenement zal bij annulatie een vergoeding van 35% verschuldigd zijn van de prijs.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">6.3. Bij niet-betaling op de vervaldag zal van rechtswege en zonder voorafgaande ingebrekestelling een schadeloosstelling van 10% bovenop een forfaitaire vergoeding van €40,- voor de invorderingskosten, ontstaan door de niet-betaling, overeenkomstig artikel 6 van de wet van 2 augustus 2002 betreffende de bestrijding van de betalingsachterstand bij handelstransacties, gewijzigd door artikel 8 van de wet van 22 november 2013.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">6.4. Verkeerde meldingen op de factuur moeten binnen de 8 dagen na de factuurdatum bij aangetekend schrijven worden meegedeeld. Na afloop van die termijn wordt de factuur geacht juist en aanvaard te zijn.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">6.5. In geval van betwisting van een deel van de geleverde goederen is de medecontractant in ieder geval gehouden tot betaling op de vervaldag van de factuur van het niet betwiste gedeelte.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">10.1. Voor Sector Nights, BR Launches of gelijkaardige evenementen zal bij een overschakeling naar een online alternatief een compensatie geleverd worden in de vorm van een gratis door VTK aangewezen optie uit de door VTK opgestelde Collaboration Brochure van het academiejaar waarin het contract geldig is.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">10.2. Voor Internship Fair, Jobfair of gelijkaardige evenementen zal bij een overschakeling naar een online alternatief een financiële compensatie geleverd worden van 25% van de prijs van de desbetreffende optie waarvoor fysieke aanwezigheid vereist is.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">Op alle door VTK Ondersteuning VZW afgesloten overeenkomsten zal uitsluitend het Belgisch recht van toepassing zijn.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
