...
>
    ...
    <xsl:template match="sale_conditions_nl">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm" text-align="justify">2.1. All oral discussions are purely informative. The agreement is only concluded by the signing of the contract by VTK Ondersteuning VZW. A beginning of execution is considered equivalent to the conclusion of a contract and to the acceptance of these general terms, unless the execution was done under explicit reservation. The execution shall be in accordance with the general terms, included in the tender, the contract, the order, the delivery note and/or the invoice, without application of the general terms of the contracting partner, even if these are communicated afterwards.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm" text-align="justify">2.2. Any cancelation of orders must be communicated in writing. It is only valid when accepted in writing by VTK Ondersteuning VZW. In case of cancelation, a lump sum depending on the subject of the agreement will be charged to the contracting partner. This lump sum covers the fixed and variable costs and possible loss of profit.
        </fo:block>
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm" text-align="justify">5.2. Hidden defects can only lead to compensation when they are communicated to VTK Ondersteuning VZW by registered letter within 8 days after delivery, and only when the goods are not yet processed by the contracting partner.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm" text-align="justify">5.3. In any case, the liability of VTK Ondersteuning VZW is limited to the replacement of the faulty goods by equivalent goods. VTK Ondersteuning VZW is not liable for any other damages for whatever reason, be it to persons, objects or the goods themselves.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm" text-align="justify">In case of force majeure, VTK Ondersteuning VZW has the right to suspend or cancel the execution of the contract. In case of force majeure, the contracting partner waives any damages.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
