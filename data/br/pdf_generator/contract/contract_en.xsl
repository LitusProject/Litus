...
>
    ...
    <xsl:template match="sale_conditions_nl">
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">5.2. Hidden defects can only lead to compensation when they are communicated to VTK Ondersteuning VZW by registered letter within 8 days after delivery, and only when the goods are not yet processed by the contracting partner.</fo:block>
        ...
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">If one or more subjects of this agreement are suscepted to measures taken or imposed by a government, the KU Leuven or another relevant authority, VTK will always try to maintain an event in a form similar to the original agreed upon concept. If these measures make it no longer possible to organise an event, an online alternative will be provided, depending on the type of event a compensation will be given.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">10.1. For Sector Nights, BR Launches or similar events, a conversion to an online event will induce a compensation in the form of a free option appointed by VTK from the Collaboration Brochure drawn up by VTK of the same academic year in which the contract was valid.</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">10.2. For Internship Fair, Jobfair or similar events, a conversion to an online event will induce a financial compensation of 25% of the price of the concerning option that requires physical presence.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
            Article 10: Force majeure</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">In case of force majeure, VTK Ondersteuning VZW has the right to suspend or cancel the execution of the contract. In case of force majeure, the contracting partner waives any damages.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
            Article 11: Applicable law</fo:block>
        <fo:block font-size="6pt" font-family="sans-serif" padding-before="0.5mm">On all the contracts concluded by VTK Ondersteuning VZW exclusively the Belgian law is applicable.</fo:block>
        <fo:block font-size="7pt" font-family="sans-serif" padding-before="0.5mm" font-weight="bold">
